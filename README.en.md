...
> - Requires “Reminders” access via TCC; permission belongs to the host process. See [docs/macos-permissions.md](docs/macos-permissions.md).
...
|------|:---:|:---:|-------|
| Regular list | ✅ | create: ✅ `add-list` / update: ✅ `update-list` (rename/icon/12-color palette) / delete: ✅ `delete-list` (write-protected) | |
...
remindkit add-list "New list"      # create a list
